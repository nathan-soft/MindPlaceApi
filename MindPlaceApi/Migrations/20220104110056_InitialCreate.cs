        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Followings_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Followings_AspNetUsers_ProfessionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedForId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Referrals", x => new { x.ReferrerId, x.ReferredUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploymentType = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Followings_PatientId_ProfessionalId",
                table: "Followings",
                columns: new[] { "PatientId", "ProfessionalId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Followings_ProfessionalId",
                table: "Followings",
                column: "ProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_Followings_Status",
                table: "Followings",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_CreatedForId",
                table: "Notifications",
                column: "CreatedForId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_UserId_CompanyName_JobTitle_StartYear",
                table: "WorkExperiences",
                columns: new[] { "UserId", "CompanyName", "JobTitle", "StartYear" },
                unique: true);
        }
